...
do
	...
	case $opcion in
			...
			*) echo -e "$opcion es una opción inválida";
	esac
done
...
do
	...
	echo -e "$blue ################################################################# $end" 
	echo
	echo -e " Detectado sistema operativo: $yellow $INFO_SISTEMA $end"
	echo
	...
	echo -e " Versión instalada:$red $ver_local $end --->  Nueva versión:$green $ver_web $end"
	echo
	echo -e "------------------------------------------------------------------"
	echo
	echo -e " 1)$green Hacer copia de seguridad de tvheadend $end"
	echo
	echo -e " 2)$cyan Instalar lista de canales, picons, grabber y configurar tvheadend $end"
	echo -e 
	echo -e " 3)$blue Hacer una limpieza total de canales $end"
	echo -e 
    echo -e " 4)$magenta Volver $end"
	echo -e 
