...
INFO_CARPETA_TVH="$(find /storage/.kodi/userdata -maxdepth 5 -type d -iname service.tvheadend*)" #Linux /home/hts/.hts/tvheadend #Synology /var/packages/tvheadend/target/var #Libreelec /storage/.kodi/userdata/addon_data/service.tvheadend43 #Alexelec /storage/.config/tvheadend
INFO_CARPETA_GRABBER="$(which tvheadend | sed 's/\/tvheadend//')"

SYSTEM=2   #1-Synology/XPEnology   2-LibreELEC/OpenELEC   3-Linux
