...
URL_SCRIPT="https://github.com/davidmuma/Canales_dobleM/raw/master/files/i_mposter.sh" 2>>i_manuelin.log
...
URL_GRABBER="https://github.com/davidmuma/Canales_dobleM/raw/master/files/P/tv_grab_EPG_dobleM" 2>>i_manuelin.log
