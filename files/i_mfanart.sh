...
URL_SCRIPT="https://github.com/davidmuma/Canales_dobleM/raw/master/files/i_mfanart.sh" 2>>i_manuelin.log
...
URL_GRABBER="https://github.com/davidmuma/Canales_dobleM/raw/master/files/F/tv_grab_EPG_dobleM" 2>>i_manuelin.log
