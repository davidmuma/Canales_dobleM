...
clear
	...
	case $opcion in
		...
		8) curl -skO https://raw.githubusercontent.com/davidmuma/Canales_dobleM/master/files/i_dobleMd.sh && clear && sudo chmod +x i_dobleMd.sh && sudo ./i_dobleMd.sh; break;;
		9) curl -sko $CARPETA_SCRIPT/i_dobleMd.sh https://raw.githubusercontent.com/davidmuma/Canales_dobleM/master/files/i_dobleMd.sh && clear && chmod +x i_dobleMd.sh && sudo -i sh $CARPETA_SCRIPT/i_dobleMd.sh; break;;
