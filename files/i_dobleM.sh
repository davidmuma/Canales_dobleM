...
clear
	...
	read opcion
	case $opcion in
		1) echo Cargando... && curl -sO https://raw.githubusercontent.com/davidmuma/Canales_dobleM/master/files/i_synology.sh && clear && sudo sh i_synology.sh; break;;
		2) echo Cargando... && curl -sO https://raw.githubusercontent.com/davidmuma/Canales_dobleM/master/files/i_libreelec.sh && clear && sh i_libreelec.sh; break;;
		3) echo Cargando... && curl -sO https://raw.githubusercontent.com/davidmuma/Canales_dobleM/master/files/i_linux.sh && clear && sudo sh i_linux.sh; break;;
